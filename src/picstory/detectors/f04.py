"""F04 · Ultrawide distortion on people — registry stub.

Claims the F04 registry slot (QUEUE.md item 2). Real detection logic
...
def detect(*_args, **_kwargs):
    raise DetectorNotImplemented(
        "F04: Ultrawide distortion on people detector not yet implemented (QUEUE.md item 4)"
    )
